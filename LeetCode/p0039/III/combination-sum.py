...
# File Name: combination-sum.py
# Author: Ynjxsjmh
# Email: ynjxsjmh@gmail.com
# Created: 2022-06-25 10:25:20
# Last Updated: 
#           By: Ynjxsjmh
# Description: Given an array of **distinct** integers `candidates`
...
class Solution(object):
    ...
    def dfs(self, candidates, target, idx, combination, combinations):
        if target < 0:
            return combinations[:]
        ...
        for i in range(idx, len(candidates)):
            ...
            res.extend(self.dfs(candidates, target-candidates[i], i, combination+[candidates[i]], combinations[:]))
