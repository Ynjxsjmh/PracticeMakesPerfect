...
# File Name: missing-number.py
# Author: Ynjxsjmh
# Email: ynjxsjmh@gmail.com
# Created: 2022-06-11 10:14:18
# Last Updated: 
#           By: Ynjxsjmh
# Description: Given an array `nums` containing `n` distinct numbers
# in the range `[0, n]`, return *the only number in the range that is
...
class Solution(object):
    ...
    def missingNumber(self, nums):
        ...
        return list(s.difference(set(nums)))[0]
